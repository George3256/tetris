...
public class CreateShape_Scr : MonoBehaviour
{
    ...
    void displayCurrentNode()
    {
        ...
        textCurrent.text = "Текущая фигура " + (currentNode + 1).ToString() + " из " + listFigure.Count.ToString();
    }
    ...
    void componentInitialization()
    {
        ...
        textCurrent = GameObject.Find("TextCurrent").GetComponent<Text>();
    ...
    void populatingAnArrayOfButtonsNext()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            {
                int z = k;
                buttonN[i][j] = GameObject.Find("Button1 (" + k.ToString() + ")").GetComponent<Button>();
    ...
    void populatingAnArrayOfButtonsPrev()
    {
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            {
                int z = k;
                buttonP[i][j] = GameObject.Find("Button (" + k.ToString() + ")").GetComponent<Button>();
